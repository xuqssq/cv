...
async function ContributionCard({ contribution }) {
    ...
    <div className="flex flex-col gap-3 group py-4">
      ...
      <div className="flex flex-col gap-2">
        <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-500 dark:text-gray-500 font-medium mb-1">Project</p>
        ...
        <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-500 dark:text-gray-500 font-medium mb-1">My Contribution</p>
          <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
